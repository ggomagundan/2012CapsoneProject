...
$(document).ready(function(){
			...
			(function(a){
				...
				if(jQuery.browser.mobile == true){
					...
					var width_size = window.screen.width;
					var height_size = window.screen.height;
...
<div id="wrapContent">
	<?php 	include_once("./top/topnav.php"); ?>
	<?php 	include_once("./rankBar/rankBar.php"); ?>
	<?php 	include_once("./adbar/top_adbar.php"); ?>
	<?php	include_once("./slide/slider.php"); ?>
	<?php 	include_once("./tabFirst/tabFirst.php");?>
	<?php 	include_once("./tabSecond/tabSecond.php");?>
	<?php 	include_once("./adbar/bottom_adbar.php"); ?>
	<?php	require_once("./info/info.php"); ?>
</div>
<hr size="3"/>
